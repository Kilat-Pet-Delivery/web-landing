...
const navItems = [
  ...
  { href: '/nearby-runners', label: 'Nearby Runners', icon: MapPin },
  { href: '/pet-shops', label: 'Pet Shops', icon: Store },
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center gap-2 border-b px-6">
        ...
        <span className="text-lg font-bold text-green-600">Kilat Pet</span>
      </div>
